...
function getStatusLabel(status: string, isNextVisit: boolean) {
  if (status === "in corso") {
    return "In corso";
  }
            ...
            <CardContent className="grid gap-3 p-4">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  >
                    {formatVisitDateTime(visit.date)} - {visit.patient}
                  </Link>
              ...
              <p className="text-sm text-slate-700">{visit.service}</p>
            </CardContent>
          </Card>
          );
        })}
